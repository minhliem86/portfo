                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="wrap-center">
                            <a href="{!! route('admin.project.create') !!}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Thêm</a>
        ...
        $(document).ready(function(){
            ...
            var table = $('table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'name', name: 'Project', title: 'Project'},
                    ...
                    {data: 'project_type_name', name: 'Project Type', title: 'Project Type'},
                ...
                initComplete: function(){
                    ...
                    $('#btn-updateOrder').click(function(){
                        ...
                        $.ajax({
                            url: '{{route("admin.project.postAjaxUpdateOrder")}}',
                            type:'POST',
