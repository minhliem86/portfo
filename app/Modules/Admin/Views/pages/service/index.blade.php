                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="wrap-center">
                            <a href="{!! route('admin.skill.create') !!}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Thêm</a>
                ...
                initComplete: function(){
                    ...
                    $('#btn-remove-all').click( function () {
                        ...
                        alertify.confirm('You can not undo this action. Are you sure ?', function(e){
                            if(e){
                                $.ajax({
                                    'url':"{!!route('admin.skill.deleteAll')!!}",
                                    'data' : {arr: data},
                                    'type': "POST",
                    ...
                    $('#btn-updateOrder').click(function(){
                        ...
                        $.ajax({
                            url: '{{route("admin.skill.postAjaxUpdateOrder")}}',
                            type:'POST',
                    ...
                    $('table.table').on('change','input[name=status]', function(){
                        ...
                        console.log(id_item);
                        $.ajax({
                            url: "{{route('admin.skill.updateStatus')}}",
                            type : 'POST',
