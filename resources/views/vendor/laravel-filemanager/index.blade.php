...
<head>
  ...
  {{--<style>{!! \File::get(base_path('public/vendor/unisharp/laravel-filemanager/public/css/lfm.css')) !!}</style>--}}
...
<body>
  ...
  {{--<script>{!! \File::get(base_path('public/vendor/unisharp/laravel-filemanager/public/js/script.js')) !!}</script>--}}
